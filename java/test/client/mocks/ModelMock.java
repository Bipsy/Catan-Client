...
public class ModelMock {
    ...
    public static ClientModelDTO getModelDTO() {
        ...
        PortDTO[] ports = {
            new PortDTO(3, null, new HexLocation(3, -3), EdgeDirection.SouthWest),
            new PortDTO(2, "ore", new HexLocation(1, -3), EdgeDirection.South),
            new PortDTO(3, null, new HexLocation(2, 1), EdgeDirection.NorthWest),
            new PortDTO(2, "wheat", new HexLocation(-1, -2), EdgeDirection.South),
            new PortDTO(2, "brick", new HexLocation(-2, 3), EdgeDirection.NorthEast),
            new PortDTO(2, "wood", new HexLocation(-3, 2), EdgeDirection.NorthEast),
            new PortDTO(2, "sheep", new HexLocation(3, -1), EdgeDirection.NorthWest),
            new PortDTO(3, null, new HexLocation(-3, 0), EdgeDirection.SouthEast),
            new PortDTO(3, null, new HexLocation(0, 3), EdgeDirection.North)
        };
