...
/**
* Class serves as a wrapper for the model of the game or game instance. It can be used as the single
* model instance for the server (iPopulator) and client facades to write and read.
